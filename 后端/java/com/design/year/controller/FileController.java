...
public class FileController {
    ...
    * */
    ...
    public Result<?> upload(MultipartFile file) throws IOException {
        ...
        String rootFilePath = System.getProperty("user.dir") + "/design/src/main/resources/files/" +  flag + "_" +originalFilename;//获取路径
        FileUtil.writeBytes(file.getBytes(), rootFilePath);// 把文件写入到上传的路径
        return Result.success(ip + ":" + port + "/files/" + flag+ "_" +originalFilename );//返回结果的url
    }
...
* */
    ...
    public void getFiles(@PathVariable String flag, HttpServletResponse response) {
        ...
        String basePath = System.getProperty("user.dir") + "/design/src/main/resources/files/";  // 定于文件上传的根路径
